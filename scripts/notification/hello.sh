...
then
    dunstify -i ~/.config/dunst/icons/charmander.svg "Good Morning" "$NAME!" -u low
...
then
    dunstify -i ~/.config/dunst/icons/squirtle.svg "Good Evening" "$NAME!" -u low
else 
    dunstify -i ~/.config/dunst/icons/venonat.svg "Demons are watching you..." -u low
fi
