...
hi Directory guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=NONE ctermfg=NONE guibg=#2c2f3f ctermbg=238 gui=NONE cterm=NONE
hi DiffChange guifg=NONE ctermfg=NONE guibg=#454f54 ctermbg=239 gui=NONE cterm=NONE
...
hi Normal guifg=#eeeeee ctermfg=255 guibg=#1B1B23 ctermbg=235 gui=NONE cterm=NONE
...
hi SpecialKey guifg=#99EBFC ctermfg=238 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StatusLineNC guifg=#999999 ctermfg=246 guibg=#99EBFC ctermbg=238 gui=NONE cterm=NONE
hi TabLine guifg=#999999 ctermfg=246 guibg=#99EBFC ctermbg=238 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE ctermfg=NONE guibg=#99EBFC ctermbg=238 gui=NONE cterm=NONE
hi TabLineSel guifg=#ACFFAD ctermfg=185 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
hi Title guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
hi Visual guifg=NONE ctermfg=NONE guibg=#1c1e28 ctermbg=237 gui=Bold cterm=Bold
hi VisualNOS guifg=NONE ctermfg=NONE guibg=#1c1e28 ctermbg=237 gui=Bold cterm=Bold
...
hi Constant guifg=#C1B3FF ctermfg=215 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Identifier guifg=#C1B3FF ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Function guifg=#ACFFAD ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Statement guifg=#C1B3FF ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Conditional guifg=#ACFFAD ctermfg=185 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Operator guifg=#C1B3FF ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Exception guifg=#C1B3FF ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Special guifg=#FFC996 ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi cssBackgroundProp guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssBorderProp guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi cssFontProp guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssPositioningProp guifg=#73cef4 ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssTextProp guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi cssProp guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi diffChanged guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi FugitiveblameHash guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi gitcommitHeader guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javaScriptBraces guifg=#f26d8c ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsonBraces guifg=#71EFA3 ctermfg=255 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownH1 guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
...
hi markdownLinkTextDelimiter guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownLinkDelimiter guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownUrlTitleDelimiter guifg=#1B1B23 ctermfg=58 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi NERDTreeHelpTitle guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptParens guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptObjectLabel guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi GitGutterChange guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javaScriptOpSymbols guifg=#C1B3FF ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi javaScriptParens guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi javaScriptDocTags guifg=#FFC996 ctermfg=242 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi javaScriptDocSeeTag guifg=#1c1e28 ctermfg=66 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsParensIfElse guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsObjectKey guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsObjectColon guifg=#C1B3FF ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsParens guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsFuncParens guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsTemplateBraces guifg=#C1B3FF ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsGlobalObjects guifg=#73cef4 ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsGlobalNodeObjects guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi plugBracket guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi plugName guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi stylusClassChar guifg=#9beeff ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi vimCommentString guifg=#1B1B23 ctermfg=58 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javascriptDocParamName guifg=#1B1B23 ctermfg=58 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
